    ...
    implements PrivilegedAction<Object>
{
    ...
    {
        REGISTER, UNREGISTER, REREGISTER, INPUT_VOLUME, PLAYBACK_VOLUME,
        CALL_CREATE, CALL_TERMINATE, CALL_REQUESTED, INVITE, TRANSFER_CALL,
        SEND_TONE, MUTE, HOLD, DEFAULT_AUDIO_DEVICE;
    }
    ...
    public String run()
    {
        try
        {
            ...
            for (int i=0; i < len; i++)
            {
                ...
                else if (params[i].getName().equals("java.lang.Integer"))
                {
                    argos[i] = new Integer(this.args[i]);
                }
                else
                {
                    // default String
